    ...
    public class RowViewModelTests
    {
        ...
        public void RefreshStatusesFromChilds_CheckCommands(string strLeftStatus, string strRightStatus, bool leftAccept)
        {
            ...
            for (byte i = 0; i < 4; i++)
            {
                ...
                leftItemViewModel.Item.CopiedFromToEvent += (IItem item1, IItem item2, string destinationPath) =>
                {
                ...
                rightItemViewModel.Item.CopiedFromToEvent += (IItem item1, IItem item2, string destinationPath) =>
                {
                    lock (resultCopyDestinationPathesLocker)
                        resultCopyDestinationPathes.Add(destinationPath);
                };
        ...
        private class TestItem : IItem
        {
            ...
            {
                return Task.Run(() => CopiedFromToEvent?.Invoke(null, null, destinationPath));
            }
